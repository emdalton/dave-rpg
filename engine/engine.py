                        ...
                        Plus exactly ONE destination:
                          to_char_id (integer) — item goes to a character's inventory
                               (also include slot: right_hand, left_hand, both_hands,
                                mouth, worn, pocket, in_pack, carried, or carried)
                          to_loc_id (integer) — item is placed at a location
                          to_item_id (integer) — item placed inside a container item
                        When to_loc_id is set, the engine marks the item is_confirmed=1
                        (the player placed it deliberately). Empty list if no items
                        moved this turn.)
